    ...
    <div className="flex flex-col md:flex-row justify-between my-8 gap-[2rem] md:gap-[4rem] lg:gap-[8rem]">
      ...
      <div className="mt-3 lg:mt-6 w-full md:w-5/8 flex flex-col gap-12 justify-between">
        <div className="flex flex-col gap-[1.5rem] md:min-h-64">
          ...
          <p className="text-sm md:text-base leading-[1.75rem] font-light text-neutral-70">
          ...
          <div className="flex flex-col lg:flex-row gap-4 text-base">
            ...
            <p className="font-semibold text-neutral-30">
              {" "}
        ...
        <div className="flex flex-row gap-8 justify-center md:justify-end">
          ...
          >
            <IconLeftArrow
              className={`text-${currentIndex === 0 ? "neutral-30" : "black"}`}
            />
          </button>
          <button
